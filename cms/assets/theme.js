...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success:function(g)
            {
                if (g == 1){
                    ...
                    $(".cropper-wrapper").find('input[type="text"]').attr("value","");
                    $(".cropper-container").find("img").remove();
                    btn.remove();
                }
                else {
                    alert("Hata Oluştu");
    ...
    $('#fileuploader input[name="files"]').fileuploader({
        ...
        theme: 'dragdrop',
        fileMaxSize:50, //mb
        extensions : ['pdf', "zip", "rar",'xls','xlsx','doc','docx'],
        upload: {
            url: BaseAdminURL +'/?cmd=Dosya/YukleWidget',
            data: {'id':$('#fileuploader input[name=id]').val(),'name':$("input[name="+$('#fileuploader input[name=baslik_tr]').val()+"]").val(),'modul':$('#fileuploader input[name=modul]').val(),'folder':$('#fileuploader input[name=folder]').val()},
            type: 'POST',
...
$(window).ready(function(e){
    ...
    var uploader = new plupload.Uploader({
        ...
        url : BaseAdminURL + '/?cmd=Dosya/yukle&son_id='+$('#pickfiles').data('id')+'&folder='+$('#pickfiles').data('url')+'&modul='+$('#pickfiles').data('type')+'&baslik='+$('#pickfiles').data('name')+'&tur='+$("#pickfiles").data("tur")+'&resim_tur='+$("#pickfiles").data("resimtur")+'&file_type='+$("#pickfiles").data("filetype"),
        ...
        filters : {
            ...
            mime_types: [
                ...
                {title : "Dosyalar", extensions : "zip,rar,doc,docx,pdf,xls,xlsx,txt,mp4"}
            ]
        },
