...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.html" class="logo">
            <!-- mini logo -->
            <b class="logo-mini">
                <span class="light-logo"> <img src="{$control->ThemeFile()}/images/logo-light.png" alt="logo" height="50"></span>
                <span class="dark-logo"><img src="{$control->ThemeFile()}/images/logo-dark.png" alt="logo" height="50"></span>
            </b>
            <!-- logo-->
            <span class="logo-lg">
	  </span>
...
<script src="{$control->BaseAdmin()}/assets/theme.js?v=5" charset="utf-8"></script>
