                        ...
                        <span class="help-block">
                            <table class="table" style="margin-bottom: 0px; margin-top: 15px;">
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                         <td style=" padding:5px;" colspan="2"><a class="remove-image-btn btn btn-danger" href="#" data-table="<?=(isset($table) ? $table : $folder)?>" data-id="<?=$id?>"><i class="fa fa-times-circle"></i> Resmi Sil</a> </td>
                                    </tr>
                                <? } }  }?>
                                </tbody>
                            </table>
