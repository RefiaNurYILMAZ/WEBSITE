...
class Urun  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Ürünler", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
            array("title" => "Ürün Kategorileri", "href" => "kategoriler", "icon" => "mdi mdi-ungroup"),
    ...
    public function ekle($id=null)
    {
      ...
      //  $text.= $form->file2(array('url'=>$this->BaseURL('upload')."/".$this->modulName,'folder'=>$this->modulName,'title'=>'Icon','name'=>'resim','resimBoyut'=>$this->modul_image_size($this->modul_info["id"]),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
        ...
        $text.= $form->file(array('url'=>$this->BaseURL('upload')."/".$this->modulName,'folder'=>$this->modulName,'title'=>'Kapak Resmi','name'=>'resim','resimBoyut'=>"600x600",'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            if($dil == "tr"):
                $post[$dil] = array(
                    ...
                    'resim' => $this->_RESIM_BASE64('resim', $this->modulName,"","jpg","80"),
    ...
    public function kategoriEkle($id=null)
    {
     ...
     $text .= $form->openColumn(4);
            ...
            $text.= $form->file(array('url'=>$this->BaseURL('upload')."/".$this->ktable,'folder'=>$this->ktable,'title'=>'Sayfa Banner Resmi','name'=>'banner_resim','resimBoyut'=>"800x600",'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
