...
class Galeri  extends Settings{
    ...
    public function ekle($id=null)
    {
        ...
        //$text.= $form->file(array('url'=>$this->BaseURL('upload')."/".$this->modulName,'folder'=>$this->modulName,'title'=>'Kapak Resmi','name'=>'SayfaResim','resimBoyut'=>$this->modul_image_size($this->modul_info["id"]),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
