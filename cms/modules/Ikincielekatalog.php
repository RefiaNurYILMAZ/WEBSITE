...
class Ikincielekatalog  extends Settings{


    public  $modulName;

    /* kategori */
    private $ktable = "ikinciel";
    private $ktablelang = "ikinciel_lang";
    /* #kategori */
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Katalog Listesi", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
    ...
    public function liste($id=null)
    {
        ...
        $text .= $pagelist->PageList(array(
            ...
            "resim"=>true,
            "search"=>true,
            'button' => array(array('title'=>'Katalog Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
