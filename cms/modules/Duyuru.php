...
class Duyuru  extends Settings{
    ...
    public function __construct($settings)
    {
        ...
        $this->tablist = array(
            array("title" => "Duyuru Listesi", "href" => "liste", "icon" => "mdi mdi-view-sequential"),
        );
    ...
    public function liste($id=null)
    {
        ...
        $text .= $pagelist->PageList(array(
            ...
            "search"=>true,
            'button' => array(array('title'=>'Duyuru Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle'),"class"=>"btn btn-success")),
            'p'=>array(
    ...
    {
        $this->SayfaBaslik = 'Duyuru '.(($id) ? "Düzenle" : "Ekle");
        $text = '';
        $tabForm = array();
